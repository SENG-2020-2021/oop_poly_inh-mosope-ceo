...
class Main {
  ...
  switch(selection){
    ...
    case 'T':    
	  ...
	  Trapezoid t = new Trapezoid(a, b, c, d,ht);
	  ...
	  System.out.println(" ");
	  System.out.printf("The area of the Trapezoid with First Side: %.2f, Second Side: %.2f, Third Side: %.2f, and Fourth Side: %.2f and hheight of: %.2f is %.2f", a, b, c, d, ht, t.calculateArea()); 
	  break;
...
class Trapezoid extends Quadilateral{
  ...
  public Trapezoid (float a, float b, float c, float d,float ht){
    side1 = a;
    side2 = b;
    side3 = c;
    side4 = d;
